...
$CONFIG = '{"lang":"ko","error_reporting":false,"show_hidden":true,"hide_Cols":false,"calc_folder":false}';
...
//Application Title
define('APP_TITLE', 'LA:RP 런처 구성 파일 관리자');
...
$auth_users = array(
    'admin' => '$2y$10$yluIT0.HaAg2/4SH3tjbrOJYq8rMsi.VnfdPtB8dZn72t/hiw3a2u'
);
...
// Default language
$lang = isset($cfg->data['lang']) ? $cfg->data['lang'] : 'ko';
...
function fm_get_translations($tr) {
    try {
        $content = @file_get_contents('manage_translation.json');
        if($content !== FALSE) {
